...
public class ImageCache {
    ...
    public static ImageCache getInstance(Context context) {
        if (sInstance == null) {
            ImageCacheParams params = new ImageCacheParams(context, DEFAULT_DISK_CACHE_NAME);
            params.setMemCacheSizePercent(0.25f);
            sInstance = new ImageCache(params);
        }
        return sInstance;
    }
     ...
     */
    public void addBitmapToCache(String data, BitmapDrawable value, boolean memoryCache) {
...
//                                    fd, Integer.MAX_VALUE, Integer.MAX_VALUE, this);
    ...
    public static class ImageCacheParams {
        ...
        public void setMemCacheSizePercent(float percent) {
            ...
            diskCacheSize = memCacheSize * 2 * 1024;
        }
    }
