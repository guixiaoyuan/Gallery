...
public class AlbumDataLoader {
    ...
    private class ReloadTask extends Thread {
        ...
        public void run() {
            ...
            while (mActive) {
                ...
                mVersion = version;// [BUGFIX]-Add by TCTNJ,su.jiang,
                                   // 2015-07-03,PR1034387
            }
            updateLoading(false);
        }
    ...
    // [BUGFIX]-Add by TCTNJ,su.jiang, 2015-07-03,PR1034387 begin
    public long getmVersion() {
        return mVersion;
    }
    // [BUGFIX]-Add by TCTNJ,su.jiang, 2015-07-03,PR1034387 end
