...
import com.tct.gallery3d.R.styleable;
import com.tct.gallery3d.app.constant.GalleryConstant;
import com.tct.gallery3d.common.BitmapUtils;
import com.tct.gallery3d.image.ImageViewState;
import com.tct.gallery3d.image.decoder.CompatDecoderFactory;
import com.tct.gallery3d.image.decoder.DecoderFactory;
import com.tct.gallery3d.image.decoder.ImageDecoder;
import com.tct.gallery3d.image.decoder.ImageRegionDecoder;
import com.tct.gallery3d.image.decoder.SkiaImageDecoder;
import com.tct.gallery3d.image.decoder.SkiaImageRegionDecoder;
    ...
    private static class TilesInitTask extends AsyncTask<Void, Void, int[]> {
            ...
            try {
                ...
                if (context != null && decoderFactory != null && view != null) {
                    ...
                    try {
                        ...
                        // If the URI is a gif file, it may throw IOException here.
                        ioException = e;
                        return null;
                    }
        ...
        protected void onPostExecute(int[] xyo) {
            ...
            if (view != null) {
                ...
                } else if (ioException != null && ioException.getMessage().contains("GIF")) {
                    // If the URI is a gif file,
        ...
        protected Integer doInBackground(Void... params) {
            try {
                ...
                if (context != null && decoderFactory != null && subsamplingScaleImageView != null) {
                    ...
                    int rotation = subsamplingScaleImageView.getExifOrientation(sourceUri);
                    ...
                    if(bitmap != null && bitmap.getWidth() > 1 && bitmap.getHeight() > 1) {
                        ...
                        DisplayMetrics dm = subsamplingScaleImageView.getResources().getDisplayMetrics();
                        float screenWidth = dm.widthPixels;
                        float screenHeight = dm.heightPixels;
                        subsamplingScaleImageView.setMaxScale(Math.max(screenWidth / width, screenHeight / height) * GalleryConstant.MAX_SCALE);
                        subsamplingScaleImageView.setDoubleTapZoomScale(Math.max(screenWidth / width, screenHeight / height) * GalleryConstant.MAX_SCALE);
                    }
