...
public class SaveVideoFileUtils {
    ...
    public static int deleteContent(Uri uri, ContentResolver contentResolver,
            SaveVideoFileInfo mDstFileInfo) {
        return contentResolver.delete(uri, Video.Media.DATA + "=?",
                new String[] { mDstFileInfo.mFile.getAbsolutePath() });
    }
