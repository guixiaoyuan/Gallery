...
public class PLFUtils {
    private static final String TAG = "PLFUtils";
    private static final String PATH = "/custpack/plf/JrdGallery/";
    private static final String FILE = "isdm_JrdGallery_defaults.xml";
    ...
    public static boolean getBoolean(Context mContext, String def_name) {
        /*MODIFIED-BEGIN by jian.pan1, 2016-04-06,BUG-1912750*/
        // remove custom share function, but not code.
        if ("def_gallery_custom_share_enable".equals(def_name)) {
            return false;
        }
        /*MODIFIED-END by jian.pan1,BUG-1912750*/
