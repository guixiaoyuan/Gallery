 ...
 */
/* 09/03/2015|    jialiang.ren     |      PR-939966       |[Gallery]Slide the delete pictures failure */
/* ----------|---------------------|----------------------|------------------------------------------ */
...
public class FilterDeleteSet extends MediaSet implements ContentListener {
    ...
    public ArrayList<MediaItem> getMediaItem(int start, int count) {
        ...
        for (int m = j - 1; m >= i; m--) {
            ...
            //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-03-09,PR939966 begin
            try {
                base.remove(k);
            } catch(IndexOutOfBoundsException e) {
               e.printStackTrace();
            }
            //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-03-09,PR939966 end
        }
        return base;
    }
