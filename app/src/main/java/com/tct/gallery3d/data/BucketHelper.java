...
class BucketHelper {
    ...
    private static final String[] PROJECTION_BUCKET = {
            ...
            ImageColumns.DATA}; //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-04-22, CR979027

    // The indices should match the above projections.
    private static final int INDEX_BUCKET_ID = 0;
    private static final int INDEX_MEDIA_TYPE = 1;
    private static final int INDEX_BUCKET_NAME = 2;
    private static final int INDEX_DATA = 3; //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-04-22, CR979027
    ...
    private static BucketEntry[] loadBucketEntriesFromFilesTable(
            ...
            while (cursor.moveToNext()) {
                if ((typeBits & (1 << cursor.getInt(INDEX_MEDIA_TYPE))) != 0) {
                    BucketEntry entry = new BucketEntry(
                            ...
                            cursor.getString(INDEX_DATA)); //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-04-22, CR979027
        ...
        Arrays.sort(entries, new Comparator<BucketEntry>() {
            @Override
            public int compare(BucketEntry a, BucketEntry b) {
                long delta = b.lastModifiedTime - a.lastModifiedTime;
                if (delta > 0) {
                    return 1;
                } else if (delta == 0) {
                    return 0;
    ...
    public static class BucketEntry {
        ...
        public long lastModifiedTime; //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-04-22, CR979027
        public String albumPath; // MODIFIED by Yaoyu.Yang, 2016-08-17,BUG-2208330
        ...
        //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-04-22, CR979027 begin
        public BucketEntry(int id, String name, String path) {
            bucketId = id;
            bucketName = Utils.ensureNotNull(name);
            ...
            albumPath = path.substring(0, path.lastIndexOf("/"));
