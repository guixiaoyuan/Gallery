...
public final class DataSourceType {
    ...
    public static final int ALBUM_CAMERA = 1;
    public static final int ALBUM_FACESHOW = 2;
    public static final int ALBUM_FAVORITE = 3;
    public static final int ALBUM_VIDEO = 4;
    public static final int ALBUM_SLOWMOTION = 5;
    public static final int ALBUH_SCREENSHOT = 6;
    public static final int ALBUM_PRIVATE = 7;
