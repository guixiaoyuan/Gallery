...
import com.tct.gallery3d.util.IdentityCache;
...
//    private WeakReference<MediaObject> mObject;
    private MediaObject mObject;//[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-06-09,PR1010585
    ...
    public void setObject(MediaObject object) {
        synchronized (Path.class) {
//            Utils.assertTrue(mObject == null || mObject == null);
            mObject = object;
        }
    }
...
//            return (mObject == null) ? null : mObject.get();
            return (mObject == null) ? null : mObject;//[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-06-09,PR1010585
        }
    }
