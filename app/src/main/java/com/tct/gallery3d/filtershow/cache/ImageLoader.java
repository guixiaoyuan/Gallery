 ...
 */
/* ----------|----------------------|----------------------|----------------- */
/* 3/1/2015  |ye.chen               |PR889104              |[Gallery]"Contact photo" with black screen is displayed after setting picture as SIM contact profile
/* ----------|----------------------|----------------------|----------------- */
/* 03/03/2015| jian.pan1            | PR937876             |The information of picture display incompletely
/* ----------|----------------------|----------------------|----------------- */
...
public final class ImageLoader {
    ...
    /* MODIFIED-BEGIN by dongliang.feng, 2016-03-22,BUG-1851031 */
    ...
    public static List<ExifTag> getExif(Context context, Uri uri) {
        ...
        if (path != null) {
            ...
            //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-03,PR937876 begin
            String mimeType = getMimeTypeForExif(localUri);
            //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-03,PR937876 end
            if (!JPEG_MIME_TYPE.equals(mimeType)) {
                return null;
            }
