...
import com.tct.gallery3d.filtershow.state.StatePanel;
...
//    private ImageButton faceBeautyButton;
//    private ImageButton cropEditButton;

    public static final String FRAGMENT_TAG = "MainPanel";
    public static final int LOOKS = 0;
    public static final int BORDERS = 1;
    public static final int GEOMETRY = 2;
//    public static final int CROPEDIT = 1;
//    public static final int FACEBEAUTY = 2;
...
//    public void loadCropEditPanel() {
//        if (mCurrentSelected == CROPEDIT) {
//            return;
//        }
//        boolean fromRight = isRightAnimation(CROPEDIT);
//        selection(mCurrentSelected, false);
//        CategoryPanel categoryPanel = new CategoryPanel();
//        categoryPanel.setAdapter(CROPEDIT);
//        setCategoryFragment(categoryPanel, fromRight);
//        mCurrentSelected = CROPEDIT;
//        selection(mCurrentSelected, true);
//    }
//
//    public void loadFaceBeautyPanel(boolean force) {
//        if (!force && mCurrentSelected == FACEBEAUTY) {
//            return;
//        }
//        boolean fromRight = isRightAnimation(FACEBEAUTY);
//        selection(mCurrentSelected, false);
//        CategoryPanel categoryPanel = new CategoryPanel();
//        categoryPanel.setAdapter(FACEBEAUTY);
//        setCategoryFragment(categoryPanel, fromRight);
//        mCurrentSelected = FACEBEAUTY;
//        selection(mCurrentSelected, true);
//    }
