 ...
 */
/* ----------|----------------------|----------------------|----------------- */
/* 06/19/2015| jian.pan1            | PR1025984            |[Android 5.1][Gallera_v5.1.13.1.0208.0]Histogram does not follow the adjustment and change
/* ----------|----------------------|----------------------|----------------- */
...
import com.tct.gallery3d.filtershow.editors.EditorCurves;
import com.tct.gallery3d.filtershow.filters.FilterCurvesRepresentation;
import com.tct.gallery3d.filtershow.filters.FiltersManager;
import com.tct.gallery3d.filtershow.filters.ImageFilterCurves;
