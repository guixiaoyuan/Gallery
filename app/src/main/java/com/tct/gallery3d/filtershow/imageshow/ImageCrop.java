 ...
 */
/* ----------|----------------------|----------------------|----------------- */
/* 05/21/2015| jian.pan1            | PR1006757            |    [SW][Gallery]Straighte is abnormal
/* ----------|----------------------|----------------------|----------------- */
/* 13/10/2015|dongliang.feng        |PR677893              |[Android 5.1][Gallery_v5.2.0.1.1.0305.0]The picture crop area is wrong */
/* ----------|----------------------|----------------------|----------------- */
...
import com.tct.gallery3d.filtershow.crop.CropDrawingUtils;
import com.tct.gallery3d.filtershow.crop.CropMath;
import com.tct.gallery3d.filtershow.crop.CropObject;
import com.tct.gallery3d.filtershow.editors.EditorCrop;
import com.tct.gallery3d.filtershow.filters.FilterCropRepresentation;
