 ...
 */
/* 01/19/2015|    jialiang.ren      |      PR-900038       |[Android5.0][Gallery_v5.1.1.0104.0]     */
/*           |                      |                      |The gallery will get back to homescreen */
/*           |                      |                      |when clicking filter fast               */
/* ----------|----------------------|----------------------|--------------------------------------- */
/* 02/09/2015|    qiang.ding1       |      PR926999        |[Force close][Gallery]Continuously press the return key to exit gallery, the gallery force close */
/* ----------|----------------------|----------------------|--------------------------------------- */
/* 05/14/2015| jian.pan1            | PR999739             |[Android][Gallery_v5.1.13.1.0202.0]The picture will stretch when clicking rotate and mirror in proper order
/* ----------|----------------------|----------------------|----------------- */
/* 06/19/2015|dongliang.feng        |PR1027295             |[Android 5.1][Gallery_v5.1.13.1.0209.0][Force close][Monitor] */
/*           |                      |                      |Gallery will force close when clicking edit button */
/* ----------|----------------------|----------------------|----------------- */
/* 07/13/2015| jian.pan1            | PR1042082            |[GAPP][Gallery]Gallery will Force close when edit a special picture
/* ----------|----------------------|----------------------|----------------- */
/* 07/17/2015| jian.pan1            | PR1044901            |[Android5.1][Gallery_Global_v5.1.13.1.0213.0]There is no save option after edit the picture.
/* ----------|----------------------|----------------------|----------------- */
/* 26/08/2015|dongliang.feng        |PR1076569             |[Monkey][Crash]CRASH: com.tct.gallery3d */
/* ----------|----------------------|----------------------|----------------- */
...
import com.tct.gallery3d.filtershow.cache.BitmapCache;
...
import com.tct.gallery3d.filtershow.pipeline.Buffer;
import com.tct.gallery3d.filtershow.pipeline.ImagePreset;
import com.tct.gallery3d.filtershow.pipeline.RenderingRequest;
import com.tct.gallery3d.filtershow.pipeline.RenderingRequestCaller;
import com.tct.gallery3d.filtershow.pipeline.SharedBuffer;
import com.tct.gallery3d.filtershow.pipeline.SharedPreset;
