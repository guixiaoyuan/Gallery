...
/* ----------|----------------|------------------|--------------------------- */
/* 05/11/2014| haoli.zhang    | FR-487461        | [Ergo] Video player        */
/*-----------|----------------|------------------|--------------------------- */
/* ========================================================================== */
...
public class ScreenModeManager {
    ...
    public void setScreenModes(final int screenModes) {
        ...
        if (LOG) {
            Log.d(TAG, "enableScreenMode(" + screenModes + ") mScreenModes=" + mScreenModes);
        }
    }
    ...
    public void setScreenMode(final int curScreenMode) {
        if (LOG) {
            Log.d(TAG, "setScreenMode(" + curScreenMode + ")");
        }
    ...
    public int getScreenMode() {
        if (LOG) {
            Log.d(TAG, "getScreenMode() return " + mScreenMode);
        }
        return mScreenMode;
    }
    ...
    public int getNextScreenMode() {
        ...
        if (LOG) {
            Log.d(TAG, "getNextScreenMode() = " + mode);
        }
        return mode;
    }
