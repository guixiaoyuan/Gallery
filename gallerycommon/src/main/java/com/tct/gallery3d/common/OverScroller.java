 ...
 */
/* ----------|----------------------|----------------------|----------------- */
/* 03/20/2015| jian.pan1            | PR955802             |Gallery albumset and albumpage slide speed is too slow.
/* ----------|----------------------|----------------------|----------------- */
...
public class OverScroller {
    ...
    static class SplineOverScroller {
        ...
        //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-20,PR955802 begin
        private static float DECELERATION_RATE = (float) (Math.log(0.65) / Math.log(0.9));
        private static final float INFLEXION = 0.4f; // Tension lines cross at (INFLEXION, 1)
        private static final float START_TENSION = 0.5f;
        private static final float END_TENSION = 1.2f;
        //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-20,PR955802 end
